...
void png2dae::separableGaussianBlurImage(QImage& image, double sigma)
{
...
void png2dae::secondDerivImage(QImage& image, double sigma)
{
        // Add your code here.
        int rd, cd, i,j;
        QRgb pixel;
...
void png2dae::sharpenImage(QImage &image, double sigma, double alpha)
{
...
void png2dae::saveImage(const QImage& image, const QString& fileName)
{
    image.save(fileName);
}
